...
import { ArrowLeft, MoreVertical, Heart, Minus, Plus, ShoppingCart } from 'lucide-react';
      ...
      <div className="details-content">
          ...
          <div>
            ...
            <div className="details-rating">
              {Array.from({ length: 5 }).map((_, i) => (
                <span key={i} className={`star ${i < Math.floor(itemData.rating) ? 'filled' : ''}`}>★</span>
              ))}
        ...
        <div className="details-section">
          ...
          <div className="quantity-selector">
            ...
            <button className="qty-btn add" onClick={handleIncrement}><Plus size={16} /></button>
          </div>
        </div>
        ...
        <div className="details-bottom-bar">
          ...
          >
             <Heart size={24} fill={isFavorite ? 'var(--primary-color)' : 'none'} color={isFavorite ? 'var(--primary-color)' : 'var(--text-secondary)'} />
          </button>
